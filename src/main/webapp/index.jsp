  ...
  <body class="animsition">
        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            ...
            <div class="right-top-bar flex-w h-full">
              ...
              <a href="login.jsp" class="flex-c-m trans-04 p-lr-25"> Logout </a>
            </div>
          </div>
        </div>
        ...
        <ul class="topbar-mobile">
          ...
          <li>
            <div class="right-top-bar flex-w h-full">
              ...
              <a href="login.jsp" class="flex-c-m p-lr-10 trans-04"> Logout </a>
              <a href="my-account.jsp" class="flex-c-m p-lr-10 trans-04">Account</a>
            </div>
          </li>
        </ul>
    ...
    <script>
      ...
      $(".js-addwish-detail").each(function () {
        var nameProduct = $(this).parent().parent().parent().find(".js-name-detail".jspl())
