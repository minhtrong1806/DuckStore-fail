            ...
            <div class="col-lg-3 m-b-30">
                <div class="w-full bg2 rounded">
                    ...
                    <div class="list-group list-group-flush p-b-30">
                        <button class="list-group-item list-group-item-action bg2 active" data-toggle="list"
                                href="#account-detail" role="tab">Account</button>
                        <button class="list-group-item list-group-item-action bg2" data-toggle="list"
                                href="#address" role="tab">Address</button>
                        <button class="list-group-item list-group-item-action bg2" data-toggle="list"
                                href="#orders" role="tab">Orders</button>
                    </div>
                </div>
            </div>
            <!-- content account -->
