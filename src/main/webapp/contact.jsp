								...
								<nav class="limiter-menu-desktop container">
										...
										<div class="menu-desktop">
												<ul class="main-menu">
														...
														<li class="active-menu"><a href="contact.jsp">Contact</a></li>
												</ul>
										</div>
										<!-- Icon header -->
				...
				<div class="container">
						<div class="flex-w flex-tr">
								<div
										...
										<form>
												<h4 class="mtext-105 cl2 txt-center p-b-30">Send Us A
														Message</h4>
												<div class="bor8 m-b-20 how-pos4-parent">
														<input
																...
																type="text"
																name="email"
																placeholder="Your Email Address"> <img
								...
								<div
										...
										<div class="flex-w w-full p-b-42">
												...
												<div class="size-212 p-t-2">
														...
														<p class="stext-115 cl6 size-213 p-t-18">Coza Store
																Center 8th floor, 379 Hudson St, New York, NY 10018 US</p>
												</div>
										</div>
										<div class="flex-w w-full p-b-42">
												<span class="fs-18 cl5 txt-center size-211"> <span
												...
												<div class="size-212 p-t-2">
														...
														<p class="stext-115 cl1 size-213 p-t-18">+1 800
																1236879</p>
												</div>
										</div>
